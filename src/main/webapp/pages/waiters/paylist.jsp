...
<script type="text/javascript">
	...
	function getOrderList(page) {
		...
		xmlAjaxRequest("getpaylist?page=" + page + "&time="
	...
	function pay(orderId,obj) {
		...
		txtAjaxRequest("requestpay?orderId=" + orderId + "&time="
				+ +Math.random(), "get", true, null, payCallback, obj, null);
        window.location.href = "${pageContext.request.contextPath}/payOrder?orderId="+ orderId;
		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					...
					<li><a href="towaitermain"><i
							class="icon-glass icon-large"></i>&nbsp; 服务点餐界面 <span
							class="sr-only">(current)</span></a></li>
					<li class="active"><a href="${pageContext.request.contextPath}/topaylist"><i
