    ...
    <script type="text/javascript">
        function deleteUser(id, name, obj) {
            ...
            if (confirm("您真的要删除员工【" + name + "】吗？")) {
                xmlAjaxRequest("deleteuser?userId=" + id + "&time="
        ...
        function getUserList(page) {
            ...
            xmlAjaxRequest("getuserbypage?page=" + page + "&time="
        ...
        function showList(responseXml, obj) {
            ...
            for (var i = 0; i < users.length; i++) {
                ...
                newLine += "class='icon-cogs icon-large' title='修改员工信息' onclick='window.location=\"tomodifyuser?userId="
                    + userId + "\"'></i>&nbsp;&nbsp;";
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-danger">
                ...
                <div style="text-align: right;">
                    如果您需要在系统中添加一名员工，请点击右边的按钮：<a href="toadd"
