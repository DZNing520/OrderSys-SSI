...
<head>
    ...
    <script type="text/javascript">
        ...
        function begin() {
            txtAjaxRequest("getrtorder?messageTitle=rtorder&time="
        ...
        function deal(obj, tableId, dishesName) {
            ...
            if (obj.className == "btn btn-success") {
                ...
                txtAjaxRequest("dishesdone?tableId=" + tableId
        ...
        function showList(responseXml, obj) {
            ...
            for (var i = 0; i < disheses.length; i++) {
                ...
                newLine += "class='icon-cogs icon-large' title='编辑菜品信息' onclick='window.location=\"tomodifydishes?dishesId="
                    + dishesId + "\"'></i>&nbsp;&nbsp;";
            ...
            <ul class="nav nav-sidebar">
                <li class="nav-header"
                    style="font-size: 18;margin-bottom: 10px;margin-left: 10px"><i
                        class="icon-coffee icon-large"></i>&nbsp;后厨
                </li>
                <li class="active"><a><i
