...
<head>
    ...
    <script type="text/javascript">
        function changecode() {
            document.getElementById("code").src = "savecode?time=" + Math.random();
        }
    ...
    <form role="form" method="post" action="login">
        ...
        <div class="form-group login-text" style="text-align: left;">
            <label>验证码:&nbsp;</label><input class="form-control login-inputcode"
                ...
                id="code" src="savecode" onclick="changecode()"
        ...
        <button class="btn btn-lg btn-primary btn-block login-text"
                 id="goBtu" type="submit">登录
        </button>
        <button class="btn btn-lg btn-primary btn-block login-text"
                onclick="regMethod()" type="button">注册
        </button>
    </form>
</div>
